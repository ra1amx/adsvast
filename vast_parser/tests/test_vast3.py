...
def _test_vast(vast_document_path):
    vast3_error_document_filename = os.path.abspath(vast_document_path)

    # Getting document content
    vast_file_content = ""
    with open(vast3_error_document_filename, mode="r") as vast_file:
        vast_file_content = vast_file.read()
